...
## 📌 Propósito
Este diretório trata do projeto/solução `Maior ou Menor`. O escopo reside na construção do experimento ou tarefa respectiva ao contexto de oficina-de-programação, focado no desenvolvimento de lógica fluida e manutenível em ecossistemas de software.
