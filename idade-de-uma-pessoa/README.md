...
## 📌 Propósito
Este diretório trata do projeto/solução `Idade de uma pessoa`. O escopo reside na construção do experimento ou tarefa respectiva ao contexto de oficina-de-programação, focado no desenvolvimento de lógica fluida e manutenível em ecossistemas de software.
